...
RUN apt-get update && \
    ...
    clang build-essential cmake ninja-build python3 python3-distutils wget git unzip zlib1g-dev && \
...
RUN cmake -G Ninja ../llvm \
    -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=/tmp/llvm -DCMAKE_C_COMPILER="clang" -DCMAKE_CXX_COMPILER="clang++" \
